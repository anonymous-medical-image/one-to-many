...
from vqgan.vq_gan.utils import shift_dim, adopt_weight, comp_getattr
from vqgan.vq_gan.model.lpips import LPIPS
from vqgan.vq_gan.model.codebook import Codebook
...
class VQGAN(pl.LightningModule):
    def __init__(self, cfg):
        ...
        self.video_discriminator = NLayerDiscriminator2D(
            cfg.dataset.image_channels, cfg.model.disc_channels, cfg.model.disc_layers, norm_layer=nn.BatchNorm2d)
